...
public class CustomerServiceRestClientImpl implements CustomerService {
	...
	// autowired RestTemplate paramater with bean define in the appconfig 
	// and urlvalue with propertie file 
	@Autowired 
	...
	public List<Customer> getCustomers() {
		...
		// make REST call // writing a request and store in response
